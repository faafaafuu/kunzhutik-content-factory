...
class Settings(BaseSettings):
    ...
    ai_video_fal_key: str | None = Field(default=None, alias="AI_VIDEO_FAL_KEY")
    ai_video_fal_model: str = Field(default="fal-ai/pixverse/v5/image-to-video", alias="AI_VIDEO_FAL_MODEL")
    ai_video_poll_timeout_seconds: float = Field(default=600.0, alias="AI_VIDEO_POLL_TIMEOUT_SECONDS")
    ai_video_poll_interval_seconds: float = Field(default=5.0, alias="AI_VIDEO_POLL_INTERVAL_SECONDS")
